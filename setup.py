...
def readme():
    with open('mmdet3d/README.md', encoding='utf-8') as f:
        content = f.read()
    return content
...
if __name__ == '__main__':
    ...
    setup(
        ...
        setup_requires=parse_requirements('docs/requirements/build.txt'),
        tests_require=parse_requirements('docs/requirements/tests.txt'),
        install_requires=parse_requirements('docs/requirements/runtime.txt'),
        extras_require={
            'all': parse_requirements('docs/requirements.txt'),
            'tests': parse_requirements('docs/requirements/tests.txt'),
            'build': parse_requirements('docs/requirements/build.txt'),
            'optional': parse_requirements('docs/requirements/optional.txt'),
            'KD4R': parse_requirements('docs/requirements/KD4R.txt'),
        },
        ext_modules=[
            make_cuda_ext(
